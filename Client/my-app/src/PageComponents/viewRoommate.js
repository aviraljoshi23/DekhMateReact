...
export default function ViewRoomMate() {
    const location = useLocation();
    const roomi = location.state;
    console.log(roomi);
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="nav nav-tabs justify-content-center border-secondary mb-4">
                    ...
                    <a class="nav-item nav-link active" data-toggle="tab" href="#tab-pane-3">Post Owner</a>
                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card mb-4">
                                    <div class="card-body text-center">
                                        <img src={"/UserProfiles/" + roomi.userId.userProfileImage} alt="avatar"
                                            class="rounded-circle img-fluid" style={{ width: 150 }} />
                                        <h5 class="my-3">{roomi.userId.userName}</h5>
