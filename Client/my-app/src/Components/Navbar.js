     ...
     <div class="container-fluid">
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="d-flex align-items-center justify-content-between bg-secondary w-100 text-decoration-none" data-toggle="collapse" href="#navbar-vertical" style={{height:67,padding:"0 30px"}}>
                    <h5 class="text-primary m-0"><i class="fa fa-book-open mr-2"></i>Subjects</h5>
                    <i class="fa fa-angle-down text-primary"></i>
                </a>
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style={{width:70,zIndex:9}}>
                        ...
                        <div class="navbar-nav py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <Link to="/search-flat" class="dropdown-item">Add Flat</Link>
                                    <Link to="/addDetail" class="dropdown-item">Add Your Detail</Link>
                                </div>
                                </div>
                            <div class="nav-item dropdown">
